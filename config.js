...
module.exports = {
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '𝑏𝑤𝑎𝑏𝑦𝑚𝑜𝑢𝑑𝑦♨︎',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ᴊᴀʀᴠɪꜱ-ᴍᴅ;https://telegra.ph/file/2b0e740cf2c421779509b.jpg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '22395064497',
  STARTING_MSG: toBool(process.env.STARTING_MSG) || true,
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'ᴊᴀʀᴠɪꜱ-ᴍᴅ;𝑏𝑤𝑎𝑏𝑦𝑚𝑜𝑢𝑑𝑦♨︎;https://telegra.ph/file/2b0e740cf2c421779509b.jpg',
